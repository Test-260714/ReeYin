...
namespace ALGO.DeepLearning.Views
{
    public partial class DeepLearningPreviewControl : UserControl
    {
        #region 参数与状态
        public static readonly DependencyProperty ModelProperty =
            DependencyProperty.Register(
                nameof(Model),
                typeof(DeepLearningModel),
                typeof(DeepLearningPreviewControl),
                new PropertyMetadata(null, OnModelChanged));

        public DeepLearningModel Model
        {
            get => (DeepLearningModel)GetValue(ModelProperty);
            set => SetValue(ModelProperty, value);
        }
        #endregion

        #region 初始化
        public DeepLearningPreviewControl()
        {
            InitializeComponent();
        }
        ...
        {
            var control = (DeepLearningPreviewControl)d;
            control.UnsubscribeModel(e.OldValue as DeepLearningModel);
            control.SubscribeModel(e.NewValue as DeepLearningModel);
        ...
        private void SubscribeModel(DeepLearningModel model)
        {
            if (model == null)
            {
                return;
        ...
        private void UnsubscribeModel(DeepLearningModel model)
        {
            if (model == null)
            {
                return;
