...
{
    public partial class FilterRegionPreviewControl : UserControl
    {
        #region 参数与状态
        public static readonly DependencyProperty ModelProperty =
            DependencyProperty.Register(
                nameof(Model),
                typeof(FilterRegionModel),
                typeof(FilterRegionPreviewControl),
                new PropertyMetadata(null, OnModelChanged));

        public FilterRegionModel Model
        {
            get => (FilterRegionModel)GetValue(ModelProperty);
        ...
        #region 初始化
        public FilterRegionPreviewControl()
        {
            InitializeComponent();
        }
        ...
        {
            var control = (FilterRegionPreviewControl)d;
            control.UnsubscribeModel(e.OldValue as FilterRegionModel);
            control.SubscribeModel(e.NewValue as FilterRegionModel);
        ...
        private void SubscribeModel(FilterRegionModel model)
        {
        ...
        private void UnsubscribeModel(FilterRegionModel model)
        {
            if (model == null || !_isSubscribed)
                return;
