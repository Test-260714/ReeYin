...
namespace ALGO.DistancePP.Views
{
    public partial class DistancePPPreviewControl : UserControl
    {
        #region 参数与状态
        public static readonly DependencyProperty ModelProperty =
            DependencyProperty.Register(
                nameof(Model),
                typeof(DistancePPModel),
                typeof(DistancePPPreviewControl),
                new PropertyMetadata(null, OnModelChanged));

        public DistancePPModel Model
        {
            get => (DistancePPModel)GetValue(ModelProperty);
        ...
        #region 初始化
        public DistancePPPreviewControl()
        {
            InitializeComponent();
        }
        ...
        {
            var control = (DistancePPPreviewControl)d;
            control.UnsubscribeModel(e.OldValue as DistancePPModel);
            control.SubscribeModel(e.NewValue as DistancePPModel);
        ...
        private void SubscribeModel(DistancePPModel model)
        {
        ...
        private void UnsubscribeModel(DistancePPModel model)
        {
            if (model == null || !_isSubscribed)
                return;
