...
{
    public class StateFlowViewModel: ObservableObject
    {
        #region Fields
        ...
        public StateFlowRunnerViewModel Runner { get; }
        ...
        public StateFlowViewModel()
        {
            PendingTransition = new TransitionViewModel();
            Runner = new StateFlowRunnerViewModel(this);
            ...
            CreateTransitionCommand = new ReeYin_V.NodifyManager.DelegateCommand<(object Source, object? Target)>(s => Transitions.Add(new TransitionViewModel
            {
