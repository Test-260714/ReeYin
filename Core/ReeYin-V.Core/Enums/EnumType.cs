...
namespace ReeYin_V.Core.Enums
{
    ...
    /// 标定板类型
    /// </summary>
    public enum eCalibrationBoardType
    {
        像素比 = 0,
        棋盘格 = 1,
        Charuco = 2,
    ...
    /// 深度学习推理设备
    /// </summary>
    public enum eDeepLearningDeviceType
    {
        CPU = 0,
        GPU = 1
    }
    ...
    /// 模型类型
    /// </summary>
    public enum eDeepLearningModelType
    {
        分类模型 = 0,
        目标检测 = 1,
        实例分割 = 2,
