...
{
    bool GetParam(std::string modelPath, std::shared_ptr<DetectionSeg::Param>& param)
    {
        ...
        if (sta)
        {
            ...
            param->SetSegThreshold(v["param"]["seg_thresh"].asFloat());
