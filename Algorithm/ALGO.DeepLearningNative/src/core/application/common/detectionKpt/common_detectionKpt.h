...
namespace DetectionKpt
{
    struct Param
    {
        ...
        void SetKptThreshold(float value) { kptThreshold = value; }
        float GetSegThreshold() { return kptThreshold; }
        ...
        void SetCategoryToKptName(std::map<int, std::vector<std::string>> value) { categoryToKptName = value; }
        std::map<int, std::vector<std::string>> GetCategoryToKptName() { return categoryToKptName; }

        void SetCategoryToSkeleton(std::map<int, std::vector<std::vector<int>>> value) { categoryToSkeleton = value; }
        std::map<int, std::vector<std::vector<int>>> SetCategoryToSkeleton() { return categoryToSkeleton; }

        void SetMaxNumKeypoints(int value) { maxNumKeypoints = value; }
        int GetMaxNumKeypoints() { return maxNumKeypoints; }
    };
    ...
    bool GetParam(std::string configFile, std::shared_ptr<DetectionKpt::Param>& param);
