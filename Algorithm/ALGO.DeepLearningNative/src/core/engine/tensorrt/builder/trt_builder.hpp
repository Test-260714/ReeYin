...
namespace TRT {
	...
	public:
		...
		ModelSource(ModelSource&& other) noexcept 
		{
			onnx_data_ = other.onnx_data_;
			onnx_data_size_ = other.onnx_data_size_;
			owns_data_ = other.owns_data_;
			type_ = other.type_;
			onnxmodel_ = std::move(other.onnxmodel_);

			other.onnx_data_ = nullptr;
			other.onnx_data_size_ = 0;
			other.owns_data_ = false;
		}

		ModelSource& operator=(ModelSource&& other) noexcept 
		{
			if (this != &other) 
			{
