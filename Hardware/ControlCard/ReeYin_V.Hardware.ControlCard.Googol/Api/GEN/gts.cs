...
namespace GoogolMotion
{
    public class mc
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_RelateEcatSlaveToMcMpgEncoder(short core, short mpg, short ecatIndex);
        [DllImport("gts.dll")]
        public static extern short GTN_StartHandwheel(short core, short slave, short master, short masterEven, short laveEven, short intervalTime, double acc, double dec, double vel, short stopWaitTime);
        [DllImport("gts.dll")]
