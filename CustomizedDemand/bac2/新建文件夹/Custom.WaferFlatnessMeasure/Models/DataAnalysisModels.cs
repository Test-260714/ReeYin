...
namespace Custom.WaferFlatnessMeasure.Models
{
    ...
    public class DataAnalysisDataSourceOption : BindableBase
    {
        ...
        private bool _hasPointCollectionTrimCountPerSide = true;
        public int PointCollectionTrimCountPerSide
        {
            get { return _hasPointCollectionTrimCountPerSide ? _pointCollectionTrimCountPerSide : 2; }
            set
            {
                _hasPointCollectionTrimCountPerSide = true;
                SetProperty(ref _pointCollectionTrimCountPerSide, Math.Max(0, value));
            }
        }
        ...
        public DataAnalysisDataSourceOption(
            ...
            int pointCollectionTrimCountPerSide = 2)
        {
            ...
            _pointCollectionTrimCountPerSide = Math.Max(0, pointCollectionTrimCountPerSide);
            _hasPointCollectionTrimCountPerSide = true;
        }

        [OnDeserialized]
        private void OnDataAnalysisDataSourceOptionDeserialized(StreamingContext context)
        {
            if (!_hasPointCollectionTrimCountPerSide)
            {
                _pointCollectionTrimCountPerSide = 2;
                _hasPointCollectionTrimCountPerSide = true;
                return;
            }

            _pointCollectionTrimCountPerSide = Math.Max(0, _pointCollectionTrimCountPerSide);
        }
    }
