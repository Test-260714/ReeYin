...
namespace Custom.LineScan.ViewModels
{
    ...
    /// </summary>
    [Serializable]
    public class LineScanViewModel : DialogViewModelBase, IViewModuleParam
    {
        #region Properties
        private LineScanModel _modelParam;
        public LineScanModel ModelParam
        {
        ...
        public void Init()
        {
            ...
            var dataPoints = OutputParamCollector.GetDataPoints(typeof(LineScanModel));
        ...
        {
            if (Param != null && (Param is LineScanModel))
                ModelParam = Param as LineScanModel;
            else
                ModelParam = new LineScanModel();
        ...
        public DelegateCommand<string> GeneralCommand => new DelegateCommand<string>((order) =>
        {
            switch (order)
            {
                ...
                case "切换相机":
                    {
                        if (ModelParam.SelectedCamera != null)
                        {
                            ModelParam.SelectedCameraName = ModelParam.SelectedCamera.CameraNo;
                        }
                    }
                    break;
                case "确认":
        ...
        public DelegateCommand LoadCommand => new DelegateCommand(() =>
        {
            ...
            if (ModelParam.SelectedCameraName != null && ModelParam.SelectedCameraName != "")
            {
                ModelParam.SelectedCamera = ModelParam.Cameras.Where(c => c.CameraNo == ModelParam.SelectedCameraName).FirstOrDefault();
            }
