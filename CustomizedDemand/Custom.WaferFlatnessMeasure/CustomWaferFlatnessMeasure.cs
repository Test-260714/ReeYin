...
namespace Custom.WaferFlatnessMeasure
{
    public class CustomWaferFlatnessMeasure : IModule
    {
        ...
        public void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterDialogAndMenu<TrajectoryDesignerTestView>(null, new MenuInfo
            {
                ModuleType = ModuleType.Custom,
                NodeType = NodeType.General,
                Title = "轨迹设计测试",
                Icon = "\ue784",
                Type = "99.半导体设备",
                Description = "SkiaSharp 自定义轨迹绘制控件测试页面",
                TargetType = typeof(TrajectoryDesignerTestView),
            });
